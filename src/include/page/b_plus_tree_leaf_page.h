...
public:
  ...
  void MoveLastToFrontOf(BPlusTreeLeafPage *recipient,BufferPoolManager *bufferpoolmanager,int index);
...
private:
  ...
  void CopyFirstFrom(const MappingType &item,BufferPoolManager *bufferpoolmanager,int index);
